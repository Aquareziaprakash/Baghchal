...
from tkinter import Tk, Label, Button, LabelFrame, Canvas, PhotoImage, NW, messagebox, Menu, Toplevel, ttk, Canvas
...
class UI(object):
    ...
    def refresh_board(self):
        ...
        self.master.after(100, lambda: self.draw_board(self.game.grid))
    ...
    # def __init__(self, master):
    #     self.master = master
    #     self.master.title("Adjustable Game Window")

    #     # Make the window resizable
    #     self.master.geometry("600x600")
    #     self.master.resizable(True, True)

    #     # Create a canvas to draw game elements
    ...
    # def refresh_board(self):
    #     self.master.after(100, lambda: self.draw_board(self.game.grid))  # Fix: use lambda
